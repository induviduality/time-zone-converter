...
## What is this?
This is a time zone converter at present. My idea for Hack APAC is to make a cross-timezone reminder app that automatically converts timezones and sets a reminder. I believe this would be a desktop app of sorts.
...
## What else?
Currently, my project can convert between timezones. Yet to implement a reminder function and a GUI.
